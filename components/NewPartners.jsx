  ...
  return (
    <section className=" dark:bg-gray-900 bg-slate-100">
      <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        ...
        <p className='mb-8 lg:mb-16 text-3xl font-semibold tracking-tight leading-tight text-center text-sky-500 dark:text-white md:text-2xl'>Esses são nossos parceiros</p>
